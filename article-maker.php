...
Use: Article form for ZMAN-NEWS
10/19/2022
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="position-relative mb-3">
                        <img class="img-fluid w-100" src="img/article-maker.png" style="object-fit: cover;">
                        <div class="overlay position-relative bg-light">
                            <div>
                                <h3 class="mb-3">Fill out the form below and click submit to upload to ZMAN-NEWS!</h3>
                                <form name="form" action="article-generate.php" method="GET"> 
                                    <input type="text" name="img" id="img" value="https://wallpaper.dog/large/999875.jpg">
                                    <!--<input type="file" name="img" id="fileToUpload"> -->
                                    <input type="text" name="title" id="title" placeholder="enter title">
                                    <input type="text" name="author" id="author" placeholder="enter name">
                                    <textarea id="article" name="article" rows="10" cols="80" wrap="hard" placeholder="Enter your crazy article here!"></textarea>
                                    <input type="submit" value="Submit" />
                                </form>
                                <h4>Not sure how to get an image address? Watch <a href="https://youtu.be/Bc40gK6XeW8">this video</a></h4>
                            </div>
                        </div>
                    </div>
                    <!-- News Detail End -->
